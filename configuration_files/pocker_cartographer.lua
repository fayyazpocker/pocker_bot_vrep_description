...
options = {
  ...
  pose_publish_period_sec = 5e-3, --5e-3 initial
...
TRAJECTORY_BUILDER_2D.min_range = 0.003
...
-- TRAJECTORY_BUILDER_2D.submaps.num_range_data = 120
-- TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 1e5
...
-- TRAJECTORY_BUILDER_2D.voxel_filter_size = 5e-3
